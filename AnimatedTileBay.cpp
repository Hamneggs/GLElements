...
AnimatedTileBay::addTile(Animation * animation, float x=0, float y=0, float z=0, 
...
AnimatedTileBay::getTileByID(int id)
{
...
AnimatedTileBay::removeTileByID(int id)
{
...
AnimatedTileBay::deleteTileByID(int id)
{
	AnimatedTile returnMe;
	unsigned int indexOf = 99999999;
	bool found = false;
...
AnimatedTileBay::getNumTiles(void)
{
	return tiles.size();
}